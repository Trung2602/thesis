...
class _Profile extends State<Profile> {
        ...
        builder: (ctx, setState) => AlertDialog(
          ...
          actions: [
            ...
            ElevatedButton(
              ...
              onPressed: () {
                _handleSave(context, ctx, setState);
              },
            ),
          ],
        ),
  ...
  Future<void> _handleSave(BuildContext context, BuildContext dialogCtx, void Function(void Function()) setState,) async {
        ...
        builder: (ctx, setState) => AlertDialog(
          ...
          actions: [
            ...
            ElevatedButton(
              child: const Text("Lưu"),
              onPressed: () {
                _handleChangePassword(context, ctx, setState,
                    oldPassController, newPassController, confirmPassController);
              },
            ),
          ],
        ),
  ...
  Future<void> _handleChangePassword(BuildContext context, BuildContext dialogCtx, void Function(void Function()) setState,
      TextEditingController oldPassController, TextEditingController newPassController, TextEditingController confirmPassController,) async {
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    SwitchListTile(
                      value: gender == "MALE",
                      onChanged: (val) => setState(() => gender = val ? "MALE" : "FEMALE"),

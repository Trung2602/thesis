...
public class ApiPaymentController {
    ...
    public ResponseEntity<?> createPayment(@RequestParam("planUuid") UUID planUuid,
        ...
        pc.setPlanUuid(plan.getUuid());      // sẽ lấy từ Plan entity
        pc.setCustomerUuid(userResponse.uuid());  // sẽ lấy từ Customer entity
